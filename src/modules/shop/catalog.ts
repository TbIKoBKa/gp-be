...
export interface Product {
  // Stable forever. `id` and the variant ids are persisted in orders.variantId and
  // resolved at delivery time, so renaming a rank must not touch them: an order
  // created before the rename and paid after it still has to resolve. Only
  // name/image/commands move. That is why id: 'prime' sits next to name: 'РЕЙДЕР'.
  id: string;
  type: ProductType;
    ...
    variants: [
      {
        ...
        label: '1 мес',
        price: 19,
        commands: [`lp user {player} parent addtemp raider 30d`],
      },
      {
        id: 'prime-3m',
        label: '3 мес',
        price: 49,
        commands: [`lp user {player} parent addtemp raider 90d`],
      },
      {
        id: 'prime-12m',
        label: '12 мес',
        price: 149,
        commands: [`lp user {player} parent addtemp raider 365d`],
      },
    ],
  },
  {
    ...
    variants: [
      {
        ...
        label: '1 мес',
        price: 29,
        commands: [`lp user {player} parent addtemp bandit 30d`],
      },
      {
        id: 'aracis-3m',
        label: '3 мес',
        price: 79,
        commands: [`lp user {player} parent addtemp bandit 90d`],
      },
      {
        id: 'aracis-12m',
        label: '12 мес',
        price: 249,
        commands: [`lp user {player} parent addtemp bandit 365d`],
      },
    ],
  },
  {
    ...
    variants: [
      {
        ...
        label: '1 мес',
        price: 49,
        commands: [`lp user {player} parent addtemp berserk 30d`],
      },
      {
        id: 'oasis-3m',
        label: '3 мес',
        price: 129,
        commands: [`lp user {player} parent addtemp berserk 90d`],
      },
      {
        id: 'oasis-12m',
        label: '12 мес',
        price: 399,
        commands: [`lp user {player} parent addtemp berserk 365d`],
      },
    ],
  },
  {
    ...
    variants: [
      {
        ...
        label: '1 мес',
        price: 69,
        commands: [`lp user {player} parent addtemp warlord 30d`],
      },
      {
        id: 'aladin-3m',
        label: '3 мес',
        price: 179,
        commands: [`lp user {player} parent addtemp warlord 90d`],
      },
      {
        id: 'aladin-12m',
        label: '12 мес',
        price: 549,
        commands: [`lp user {player} parent addtemp warlord 365d`],
      },
    ],
  },
  {
    ...
    variants: [
      {
        ...
        label: '1 мес',
        price: 99,
        commands: [`lp user {player} parent addtemp baron 30d`],
      },
      {
        id: 'lotus-3m',
        label: '3 мес',
        price: 249,
        commands: [`lp user {player} parent addtemp baron 90d`],
      },
      {
        id: 'lotus-12m',
        label: '12 мес',
        price: 749,
        commands: [`lp user {player} parent addtemp baron 365d`],
      },
    ],
  },
  {
    ...
    variants: [
      {
        ...
        label: '1 мес',
        price: 149,
        commands: [`lp user {player} parent addtemp khan 30d`],
      },
      {
        id: 'dune-3m',
        label: '3 мес',
        price: 379,
        commands: [`lp user {player} parent addtemp khan 90d`],
      },
      {
        id: 'dune-12m',
        label: '12 мес',
        price: 1149,
        commands: [`lp user {player} parent addtemp khan 365d`],
      },
    ],
  },
  {
    ...
    variants: [
      {
        ...
        label: '1 мес',
        price: 249,
        commands: [`lp user {player} parent addtemp despot 30d`],
      },
      {
        id: 'dejavu-3m',
        label: '3 мес',
        price: 629,
        commands: [`lp user {player} parent addtemp despot 90d`],
      },
      {
        id: 'dejavu-12m',
        label: '12 мес',
        price: 1899,
        commands: [`lp user {player} parent addtemp despot 365d`],
      },
    ],
  },
  {
    ...
    server: 'grief',
    name: 'ОВЕРЛОРД',
    image: '/images/shop/overlord.png',
    ...
    variants: [
      {
        ...
        label: '1 мес',
        price: 499,
        commands: [`lp user {player} parent addtemp overlord 30d`],
      },
      {
        id: 'mirage-3m',
        label: '3 мес',
        price: 1249,
        commands: [`lp user {player} parent addtemp overlord 90d`],
      },
      {
        id: 'mirage-12m',
        label: '12 мес',
        price: 3749,
        commands: [`lp user {player} parent addtemp overlord 365d`],
      },
    ],
  },
  {
