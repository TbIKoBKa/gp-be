    ...
    variants: [
      {
        ...
        label: '1 мес',
        price: 199,
        commands: [`lp user {player} parent addtemp sponsor 30d`],
      },
      {
        id: 'vanilla-sponsor-3m',
        label: '3 мес',
        price: 549,
        commands: [`lp user {player} parent addtemp sponsor 90d`],
      },
      {
        id: 'vanilla-sponsor-6m',
        label: '6 мес',
        price: 999,
        commands: [`lp user {player} parent addtemp sponsor 180d`],
      },
    ],
  },
];
